window.wxMiniGame = function (e, t) {
  ...
  class i {
    ...
    static isNetFile(e) {
      return (
        ...
        -1 == e.indexOf(l.window.wx.env.USER_DATA_PATH)
      );
    }
    ...
    static read(e, a = "utf8", n = null, s = "", o = !1, r = "") {
      var l;
      (l =
        "" == s || (-1 == s.indexOf("http://") && -1 == s.indexOf("https://"))
          ? e
          : i.getFileNativePath(e)),
    ...
    static downFiles(e, t = "utf8", a = null, n = "", s = !1, o = "", r = !0) {
      i.down({
        url: e,
        success: function (l) {
          200 === l.statusCode
            ? i.readFile(l.tempFilePath, t, a, n, s, o, r)
            : 403 === l.statusCode
              ? null != a && a.runWith([0, e])
              : null != a && a.runWith([1, l]);
        },
        fail: function (e) {
    ...
    static readFile(e, a = "utf8", n = null, s = "", o = !1, r = "", d = !0) {
        ...
        i.fs.readFile({
          ...
          success: function (t) {
            ...
            -1 != e.indexOf(l.window.wx.env.USER_DATA_PATH)
              ...
              : l.AutoCacheDownFile || o
                ? (null != n && n.runWith([0, t]),
                  i.copyTOCache(e, s, null, a, d))
                : null != n && n.runWith([0, t]);
          },
          fail: function (e) {
    ...
    static downOtherFiles(e, t = null, a = "", n = !1, s = !0) {
      i.down({
        ...
        success: function (e) {
          200 === e.statusCode
            ? (l.autoCacheFile || n) &&
              -1 == a.indexOf("qlogo.cn") &&
              -1 == a.indexOf(".php")
              ? (null != t && t.runWith([0, e.tempFilePath]),
                i.copyTOCache(e.tempFilePath, a, null, "", s))
              : null != t && t.runWith([0, e.tempFilePath])
    ...
    static downLoadFile(e, a = "", n = null, s = "utf8") {
      window.navigator.userAgent.indexOf("MiniGame") < 0
        ? t.Laya.loader.load(e, n)
        : a == t.Loader.IMAGE || a == t.Loader.SOUND
          ? i.downOtherFiles(e, n, e, !0, !1)
          : i.downFiles(e, s, n, e, !0, a, !1);
    }
        ...
        ? c.readyUrl != a
          ? i.fs.getFileInfo({
              ...
              success: function (t) {
                o &&
                  p + 4194304 + t.size >= f &&
                  (t.size > l.minClearSize && (l.minClearSize = t.size),
                  i.onClearCacheRes()),
                  i.deleteFile(e, a, n, s, t.size);
              },
              fail: function (e) {
    ...
    static deleteAll() {
      ...
      i.filesListObj &&
        i.filesListObj.fileUsedSize &&
        (i.filesListObj.fileUsedSize = 0),
        i.writeFilesList("", JSON.stringify({}), !1);
    }
    static onSaveFile(e, a, n = !0, s = "", o = null, r = 0) {
      var l = e;
      if (
        (null == i.filesListObj.fileUsedSize &&
          (i.filesListObj.fileUsedSize = 0),
        n)
      ) {
        ...
        (i.filesListObj[l] = {
          ...
          (i.filesListObj.fileUsedSize =
            parseInt(i.filesListObj.fileUsedSize) + r),
          i.writeFilesList(l, JSON.stringify(i.filesListObj), !0),
          null != o && o.runWith([0]);
      } else if (i.filesListObj[l]) {
        var d = parseInt(i.filesListObj[l].size);
        (i.filesListObj.fileUsedSize =
          parseInt(i.filesListObj.fileUsedSize) - d),
          i.fakeObj[l].md5 == i.filesListObj[l].md5 && delete i.fakeObj[l],
          delete i.filesListObj[l],
          i.writeFilesList(l, JSON.stringify(i.filesListObj), !1),
          null != o && o.runWith([0]);
      }
    }
    ...
    static getCacheUseSize() {
      return i.filesListObj && i.filesListObj.fileUsedSize
        ? i.filesListObj.fileUsedSize
        : 0;
    }
    static getCacheList(e, t) {
      ...
      a
        ? i.readSync(i.fileListName, "utf8", t)
        : (i.fs.mkdirSync(e, !0), t && t.runWith([1]));
    }
    static existDir(e, t) {
      i.fs.mkdir({
        dirPath: e,
    ...
    static readSync(e, t = "utf8", a = null, n = "") {
      ...
      try {
        (s = i.fs.readFileSync(o, t)), null != a && a.runWith([0, { data: s }]);
      } catch (e) {
        null != a && a.runWith([1]);
      }
    }
  ...
  (i.fs = window.wx.getFileSystemManager()),
    (i.down = window.wx.downloadFile),
    (i.filesListObj = {}),
    (i.fakeObj = {}),
    (i.fileListName = "layaairfiles.txt"),
    (i.ziyuFileData = {}),
    (i.ziyuFileTextureData = {}),
    (i.loadPath = ""),
    (i.DESCENDING = 2),
    (i.NUMERIC = 16);
  class a extends t.SoundChannel {
    ...
    __onEnd() {
      if (1 == this.loops)
        return (
          ...
          this.stop(),
          void this.event(t.Event.COMPLETE)
        );
      this.loops > 0 && this.loops--, (this.startTime = 0), this.play();
    }
    play() {
      (this.isStopped = !1),
        t.SoundManager.addChannel(this),
    ...
    stop() {
      super.stop(),
        (this.isStopped = !0),
        t.SoundManager.removeChannel(this),
        (this.completeHandler = null),
        this._audio &&
          (this._audio.stop(),
          this.loop ||
  ...
  class n extends t.EventDispatcher {
    ...
    load(e) {
      ...
      if (
        ((this.url = e),
        (this.readyUrl = e),
        l.autoCacheFile && i.getFileInfo(e))
      )
        ...
        if (i.isLocalNativeFile(e)) {
          ...
          i.isNetFile(e)
            ? i.downOtherFiles(
                e,
                t.Handler.create(this, this.onDownLoadCallBack, [e]),
                e,
              )
            : this.onDownLoadCallBack(e, 0);
  ...
  class s {
    ...
    static _createInputElement() {
      t.Input._initInput((t.Input.area = t.Browser.createElement("textarea"))),
        t.Input._initInput((t.Input.input = t.Browser.createElement("input"))),
        (t.Input.inputContainer = t.Browser.createElement("div")),
        (t.Input.inputContainer.style.position = "absolute"),
        ...
        l.window.wx.onWindowResize &&
          l.window.wx.onWindowResize(function (e) {}),
        (t.SoundManager._soundClass = n),
        (t.SoundManager._musicClass = n);
      var e = l.systemInfo.model,
        i = l.systemInfo.system;
      -1 != e.indexOf("iPhone") &&
        ((t.Browser.onIPhone = !0),
        (t.Browser.onIOS = !0),
        (t.Browser.onIPad = !0),
        (t.Browser.onAndroid = !1)),
        (-1 == i.indexOf("Android") && -1 == i.indexOf("Adr")) ||
          ((t.Browser.onAndroid = !0),
          (t.Browser.onIPhone = !1),
          (t.Browser.onIOS = !1),
          (t.Browser.onIPad = !1));
    }
    static _onStageResize() {
      t.Laya.stage._canvasTransform
        .identity()
        .scale(
          t.Browser.width / t.Render.canvas.width / t.Browser.pixelRatio,
          t.Browser.height / t.Render.canvas.height / t.Browser.pixelRatio,
        );
    }
    static wxinputFocus(e) {
      var i = t.Input.inputElement.target;
      (i && !i.editable) ||
        (l.window.wx.offKeyboardConfirm(),
        l.window.wx.offKeyboardInput(),
        ...
        l.window.wx.onKeyboardConfirm(function (e) {
          ...
          i._restrictPattern &&
            ((a = a.replace(/\u2006|\x27/g, "")),
            i._restrictPattern.test(a) &&
              (a = a.replace(i._restrictPattern, ""))),
            (i.text = a),
            i.event(t.Event.INPUT),
            s.inputEnter(),
            i.event("confirm");
        }),
  ...
  class o extends t.EventDispatcher {
    ...
    _loadSound(e) {
      if (l.autoCacheFile) {
        ...
        i.isLocalNativeFile(e) || i.getFileInfo(a)
          ? o.onDownLoadCallBack(e, this, 0)
          : i.isNetFile(a)
            ? i.downOtherFiles(
                a,
                t.Handler.create(o, o.onDownLoadCallBack, [a, this]),
                a,
              )
            : o.onDownLoadCallBack(e, this, 0);
    ...
    static onDownLoadCallBack(e, a, n, s = null) {
      if (n) a.event(t.Event.ERROR, "Load sound failed");
        ...
        if (l.autoCacheFile)
          if (s) o = s;
          else if (i.isLocalNativeFile(e)) o = e;
          else {
    ...
    complete(e) {
      e instanceof t.Resource
        ? e._setCreateURL(this.sourceUrl)
        : e instanceof t.Texture &&
          e.bitmap instanceof t.Resource &&
          e.bitmap._setCreateURL(this.sourceUrl),
        this.originComplete(e);
    }
    _loadHttpRequestWhat(e, a) {
      var n = l.getUrlEncode(e, a);
      if (t.Loader.preLoadedMap[e]) this.onLoaded(t.Loader.preLoadedMap[e]);
      else {
        ...
        if (l.AutoCacheDownFile)
          if (i.isLocalNativeFile(e) || i.getFileInfo(s)) {
            var r = e,
              d = i.getFileInfo(s);
            d && d.md5 && (r = i.getFileNativePath(d.md5)),
              i.readFile(
                r,
                n,
                new t.Handler(o, o.onReadNativeCallBack, [e, a, this]),
                e,
              );
          } else
            i.isNetFile(s)
    ...
    static onReadNativeCallBack(e, i = null, a = null, n = 0, s = null) {
      ...
      n
        ? 1 == n &&
          a._loadHttpRequest(e, i, a, a.onLoaded, a, a.onProgress, a, a.onError)
        : ((o =
            i == t.Loader.JSON ||
            i == t.Loader.ATLAS ||
            i == t.Loader.PREFAB ||
            i == t.Loader.PLF
              ? l.getJson(s.data)
              : i == t.Loader.XML
                ? t.Utils.parseXMLFromString(s.data)
                : s.data),
          !l.isZiYu &&
            l.isPosMsgYu &&
            i != t.Loader.BUFFER &&
            l.window.wx.postMessage({ url: e, data: o, isLoad: "filedata" }),
          a.onLoaded(o));
    }
    static _transformImgUrl(e, a, n) {
      if (l.isZiYu || i.isLocalNativeFile(e)) n._loadImage(e, !1);
      else if (l.autoCacheFile) {
        var s = t.URL.formatURL(e);
        i.isLocalNativeFile(e) || i.getFileInfo(s)
          ? o.onCreateImage(e, n)
          : i.isNetFile(s)
            ? i.downOtherFiles(
                s,
                new t.Handler(o, o.onDownImgCallBack, [e, n]),
                s,
              )
            : o.onCreateImage(e, n, !0);
      } else n._loadImage(e);
    }
  ...
  class r {
    ...
    static setItem(e, t) {
      try {
        ...
        l.window.wx.setStorage({ key: e, data: t });
      }
    }
    static getItem(e) {
    ...
    static getStorageInfoSync() {
      try {
        ...
        return (
          console.log(e.keys),
          console.log(e.currentSize),
          console.log(e.limitSize),
          e
        );
      } catch (e) {}
      return null;
  ...
  class l {
    ...
    static init(e = !1, a = !1) {
      l._inited ||
        ((l._inited = !0),
        (l.window = window),
        l.window.hasOwnProperty("wx") &&
          (l.window.navigator.userAgent.indexOf("MiniGame") < 0 ||
            ((l.isZiYu = a),
            (l.isPosMsgYu = e),
            (l.EnvConfig = {}),
            l.isZiYu ||
              (i.setNativeFileDir("/layaairGame"),
              i.getCacheList(
                i.fileNativeDir,
                t.Handler.create(l, l.onMkdirCallBack),
              )),
            (l.systemInfo = l.window.wx.getSystemInfoSync()),
            (l.window.focus = function () {}),
            (t.Laya._getUrlPath = function () {
              return "";
            }),
            (l.window.logtime = function (e) {}),
            (l.window.alertTimeLog = function (e) {}),
            (l.window.resetShareInfo = function () {}),
            (l.window.CanvasRenderingContext2D = function () {}),
            (l.window.CanvasRenderingContext2D.prototype = l.window.wx
              .createCanvas()
              .getContext("2d").__proto__),
            (l.window.document.body.appendChild = function () {}),
            (l.EnvConfig.pixelRatioInt = 0),
            (t.Browser._pixelRatio = l.pixelRatio()),
            (l._preCreateElement = t.Browser.createElement),
            (t.Browser.createElement = l.createElement),
            (t.RunDriver.createShaderCondition = l.createShaderCondition),
            (t.Utils.parseXMLFromString = l.parseXMLFromString),
            (t.Input._createInputElement = s._createInputElement),
            (t.Loader.prototype._loadResourceFilter =
              o.prototype._loadResourceFilter),
            (t.Loader.prototype.originComplete = t.Loader.prototype.complete),
            (t.Loader.prototype.complete = o.prototype.complete),
            (t.Loader.prototype._loadSound = o.prototype._loadSound),
            (t.Loader.prototype._loadHttpRequestWhat =
              o.prototype._loadHttpRequestWhat),
            (t.LocalStorage._baseClass = r),
            r.__init__(),
            l.window.wx.onMessage && l.window.wx.onMessage(l._onMessage))));
    }
    static _onMessage(e) {
      switch (e.type) {
        case "changeMatrix":
          t.Laya.stage.transform.identity(),
            (t.Laya.stage._width = e.w),
            (t.Laya.stage._height = e.h),
            (t.Laya.stage._canvasTransform = new t.Matrix(
              e.a,
              e.b,
              e.c,
              e.d,
      ...
      "opendatacontext" == e.isLoad
        ? e.url &&
          ((i.ziyuFileData[e.url] = e.atlasdata),
          (i.ziyuFileTextureData[e.imgReadyUrl] = e.imgNativeUrl))
        : "openJsondatacontext" == e.isLoad
          ? e.url && (i.ziyuFileData[e.url] = e.atlasdata)
          : "openJsondatacontextPic" == e.isLoad &&
            (i.ziyuFileTextureData[e.imgReadyUrl] = e.imgNativeUrl);
    }
    ...
    static onMkdirCallBack(e, t) {
      e
        ? ((i.fakeObj = {}), (i.filesListObj = {}))
        : ((i.filesListObj = JSON.parse(t.data)),
      ...
      if (a.length) {
        var n,
          s,
          o = {};
        for (let e in i.filesListObj)
          "fileUsedSize" != e && (o[(n = i.filesListObj[e]).md5] = n.readyUrl);
        for (let e = 0, t = a.length; e < t; e++)
          if ((s = a[e]) != i.fileListName) {
            if (!o[s]) {
        ...
        for (let e in o)
          delete i.filesListObj[o[e]],
            delete i.fakeObj[o[e]],
            console.log("删除错误记录：", o[e]);
      }
    }
    static pixelRatio() {
      if (!l.EnvConfig.pixelRatioInt)
        try {
          return (
            (l.EnvConfig.pixelRatioInt = l.systemInfo.pixelRatio),
    ...
    static createElement(e) {
      ...
      if ("canvas" == e)
        return (
          1 == l.idx
            ? l.isZiYu
              ? ((t = l.window.sharedCanvas).style = {})
              : (t = l.window.canvas)
            : (t = l.window.wx.createCanvas()),
          l.idx++,
          t
        );
    ...
    static onCreateInput(e) {
      ...
      return (
        (t.focus = s.wxinputFocus),
        (t.blur = s.wxinputblur),
        (t.style = {}),
        (t.value = 0),
        (t.parentElement = {}),
        (t.placeholder = {}),
    ...
    static sendAtlasToOpenDataContext(e) {
      if (!l.isZiYu) {
        ...
        if (i.meta && i.meta.image)
          for (
            var a = i.meta.image.split(","),
              n = e.indexOf("/") >= 0 ? "/" : "\\",
              s = e.lastIndexOf(n),
              o = s >= 0 ? e.substr(0, s + 1) : "",
              r = 0,
              d = a.length;
            r < d;
            r++
        ...
        for (r = 0; r < a.length; r++) {
          var u = a[r];
          l.postInfoToContext(
            t.Laya.URL.formatURL(e),
            t.Laya.URL.formatURL(u),
            i,
          );
        }
      }
    ...
    static postInfoToContext(e, a, n) {
      var s = { frames: n.frames, meta: n.meta },
        o = a,
        r = i.getFileInfo(t.URL.formatURL(a));
      if (r)
        var d = r.md5,
          u = i.getFileNativePath(d);
      else u = o;
  ...
  (l._inited = !1),
    ...
    (l.sizeLimit = 209715200),
    (l.nativefiles = ["layaNativeDir", "wxlocal"]),
    (l.subNativeFiles = []),
    (l.subNativeheads = []),
    (l.subMaps = []),
  ...
  class d extends t.EventDispatcher {
    ...
    static onAccelerometerChange(e) {
      var t;
      ((t = {}).acceleration = e),
        (t.accelerationIncludingGravity = e),
        (t.rotationRate = {}),
    ...
    on(e, t, i, a = null) {
      return (
        super.on(e, t, i, a),
        d.startListen(this.onDeviceOrientationChange),
        this
      );
    }
    off(e, t, i, a = !1) {
  ...
  class u {
    constructor() {}
    static __init__() {
      (l.window.navigator.geolocation.getCurrentPosition =
        u.getCurrentPosition),
        (l.window.navigator.geolocation.watchPosition = u.watchPosition),
    ...
    static watchPosition(e = null, i = null, a = null) {
      ...
      return (
        ...
        ((n = {}).success = e),
        (n.error = i),
        (u._watchDic[u._curID] = n),
        t.Laya.systemTimer.loop(1e3, null, u._myLoop),
        u._curID
      );
    }
    static clearWatch(e) {
      delete u._watchDic[e],
        u._hasWatch() || t.Laya.systemTimer.clear(null, u._myLoop);
    }
    static _hasWatch() {
      var e;
  ...
  (e.MiniAccelerator = d),
    ...
    (e.MiniInput = s),
    (e.MiniLoader = o),
    (e.MiniLocalStorage = r),
    (e.MiniLocation = u),
    (e.MiniSound = n),
    (e.MiniSoundChannel = a),
    (e.MiniVideo = class {
      constructor(e = 320, t = 240) {
        (this.videoend = !1),
          (this.videourl = ""),
          (this.videoElement = l.window.wx.createVideo({
            width: e,
            height: t,
            autoplay: !0,
          }));
      ...
      onPlayFunction() {
        this.videoElement && (this.videoElement.readyState = 200),
          console.log("=====视频加载完成========"),
      ...
      onEndedFunction() {
        this.videoElement &&
          ((this.videoend = !0),
          console.log("=====视频播放完毕========"),
          null != this.onEndedFunC && this.onEndedFunC());
      }
      off(e, t, i) {
        "loadedmetadata" == e
          ? ((this.onPlayFunc = i.bind(t)),
      ...
      size(e, t) {
        this.videoElement &&
          ((this.videoElement.width = e), (this.videoElement.height = t));
      }
      get x() {
      ...
      destroy() {
        this.videoElement && this.videoElement.destroy(),
