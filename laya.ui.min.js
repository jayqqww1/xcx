!(function (t, e) {
  ...
  class h extends e.Graphics {
    ...
    _createDrawTexture(
      ...
      if (
        (h || (h = t.sourceWidth), r || (r = t.sourceHeight), t.getIsReady())
      ) {
        var c = h / t.sourceWidth,
          d = r / t.sourceHeight;
        if (((h = t.width * c), (r = t.height * d), h <= 0 || r <= 0))
          return null;
    ...
    drawBitmap(t, e, s, i, h = 0, r = 0) {
      h < 0.1 ||
        r < 0.1 ||
        (!t || (e.width == h && e.height == r)
          ? this.drawImage(e, s, i, h, r)
          : this.fillTexture(e, s, i, h, r));
    }
    static getTexture(t, s, i, h, r) {
      ...
      return (
        ...
        (a && a._getSource()) ||
          (a = e.Texture.createFromTexture(t, s, i, h, r)),
        a
      );
    }
    _setDrawGridCmd(t) {
  ...
  (r.EMPTY = null),
    e.ILaya.regClass(r),
    (r.EMPTY = new r()),
    e.ClassUtils.regClass("laya.ui.Widget", r),
    e.ClassUtils.regClass("Laya.Widget", r);
  class a extends e.Event {}
  (a.SHOW_TIP = "showtip"),
    (a.HIDE_TIP = "hidetip"),
    e.ILaya.regClass(a),
    e.ClassUtils.regClass("laya.ui.UIEvent", a),
  ...
  class l {
    static fillArray(t, e, s = null) {
      ...
      if (e)
        for (
          var h = e.split(","), r = 0, a = Math.min(i.length, h.length);
          r < a;
          r++
        ) {
          var l = h[r];
          (i[r] = "true" == l || ("false" != l && l)),
            null != s && (i[r] = s(l));
        }
      return i;
    }
  ...
  class n extends e.Sprite {
    ...
    _sizeChanged() {
      isNaN(this._anchorX) || (this.pivotX = this.anchorX * this.width),
        ...
        this._widget !== r.EMPTY && this._widget.resetLayout();
    }
    get tag() {
      return this._tag;
    }
    ...
    _getWidget() {
      return (
        this._widget === r.EMPTY && (this._widget = this.addComponent(r)),
        this._widget
      );
    }
    set scaleX(t) {
    ...
    set_scaleX(t) {
      super.get_scaleX() != t &&
        (super.set_scaleX(t), this.event(e.Event.RESIZE));
    }
    get scaleX() {
      return super.scaleX;
    }
    ...
    set_scaleY(t) {
      super.get_scaleY() != t &&
        (super.set_scaleY(t), this.event(e.Event.RESIZE));
    }
    get scaleY() {
      return super.scaleY;
    }
        ...
        if ((e.Utils.isOkTextureList(r) || (r = null), r)) this._sources = r;
          ...
          if (((this._sources = []), 1 === this._stateNum))
            ...
            for (var a = 0; a < this._stateNum; a++)
              this._sources.push(
                e.Texture.createFromTexture(t, 0, i * a, s, i),
              );
    ...
    onStageMouseUp2(t) {
      if (
        ...
        if (((this._target.mouseEnabled = !0), this._isElastic))
          ...
          for (
            var s = 0, i = Math.min(this._offsets.length, 3), h = 0;
            h < i;
            h++
          )
            s += this._offsets[this._offsets.length - 1 - h];
          if (
            ((this._lastOffset = s / i), (s = Math.abs(this._lastOffset)) < 2)
          )
  ...
  class y extends c {
    ...
    _createItems(t, e, s) {
      var i = this._content,
        h = this._getOneCell(),
        r = h.width + this._spaceX,
        a = h.height + this._spaceY;
      if (this.cacheContent) {
        var l = new c();
        (l.cacheAs = "normal"),
          l.pos((this._isVertical ? 0 : t) * r, (this._isVertical ? t : 0) * a),
      ...
      for (var d = t; d < s; d++)
        for (var u = 0; u < e; u++)
          ((h = n && n.length ? n.pop() : this.createItem()).x =
            (this._isVertical ? u : d) * r - i._x),
            (h.y = (this._isVertical ? d : u) * a - i._y),
            (h.name = "item" + (d * e + u)),
            i.addChild(h),
            this.addCell(h);
    }
    createItem() {
      ...
      if (0 == t.length && s._watchMap) {
        var i = s._watchMap;
        for (var h in i)
          for (var r = i[h], a = 0; a < r.length; a++) {
            var l = r[a];
    ...
    onScrollBarChange(t = null) {
      ...
      if (this.cacheContent)
        (a = i + 1),
          this._createdLine - h < a &&
            (this._createItems(this._createdLine, s, this._createdLine + a),
      ...
      this._isVertical
        ? ((u.y = e - this._offset.y), (u.x = -this._offset.x))
        : ((u.y = -this._offset.y), (u.x = e - this._offset.x)),
    ...
    updateArray(t) {
      ...
      if (
        ((this._array = t),
        this._array &&
          ((e = this._preLen - this._startIndex) >= 0 && this.renderItems(e),
          (this._preLen = this._array.length)),
        this._scrollBar)
      ) {
        var s = t.length,
          ...
          r = Math.ceil(s / i);
        r >= h &&
          ((this._scrollBar.thumbPercent = h / r),
          (this._scrollBar.slider._max =
            (r - h) * this._cellSize + this._cellOffset));
      }
    }
    get page() {
      return this._page;
  ...
  e.ILaya.regClass(y),
    e.ClassUtils.regClass("laya.ui.List", y),
    e.ClassUtils.regClass("Laya.List", y);
  class b extends n {
    ...
    onlistItemMouse(t, s) {
      ...
      if (i === e.Event.MOUSE_OVER || i === e.Event.MOUSE_OUT) {
        ...
        r &&
          (i === e.Event.ROLL_OVER
            ? ((r.bgColor = this._itemColors[0]),
              (r.color = this._itemColors[1]))
            : ((r.bgColor = null), (r.color = this._itemColors[2])));
      } else
  ...
  e.ILaya.regClass(b),
    e.ClassUtils.regClass("laya.ui.ComboBox", b),
    e.ClassUtils.regClass("Laya.ComboBox", b);
  class w extends n {
    constructor(t = null) {
  ...
  class M extends k {
    ...
    changeScroll() {
      var t = this._vScrollBar && this._tf.maxScrollY > 0,
        ...
        r = this._tf.padding || i.labelPadding;
      (this._tf.width = s),
        (this._tf.height = h),
        this._vScrollBar &&
          ((this._vScrollBar.x = this._width - this._vScrollBar.width - r[2]),
          (this._vScrollBar.y = r[1]),
          (this._vScrollBar.height =
            this._height - (e ? this._hScrollBar.height : 0) - r[1] - r[3]),
        ...
        this._hScrollBar &&
          ((this._hScrollBar.x = r[0]),
          (this._hScrollBar.y = this._height - this._hScrollBar.height - r[3]),
          (this._hScrollBar.width =
            this._width - (t ? this._vScrollBar.width : 0) - r[0] - r[2]),
          (this._hScrollBar.scrollSize = Math.max(0.033 * s, 1)),
  ...
  class z extends c {
    ...
    changeScroll() {
      ...
      var t = this.contentWidth || 1,
        ...
        h = s && e > this._height,
        r = i && t > this._width,
        a = h ? this._width - s.width : this._width,
        l = r ? this._height - i.height : this._height;
      s &&
        ((s.x = this._width - s.width),
        (s.y = 0),
        (s.height = this._height - (r ? i.height : 0)),
  ...
  class D extends c {
    ...
    createChildren() {
      this.addChild((this._list = new y())),
    ...
    renderItem(t, s) {
      ...
      if (i) {
        ...
        r &&
          (2 == r.clipY
            ? (r.index = i.isDirectory ? 0 : 1)
            : (r.index = i.isDirectory ? (i.isOpen ? 1 : 0) : 2)),
  ...
  e.ILaya.regClass(H),
    e.ClassUtils.regClass("laya.ui.LayoutBox", H),
    e.ClassUtils.regClass("Laya.LayoutBox", H);
  class A extends H {
    sortItem(t) {
      t &&
        t.sort(function (t, e) {
    ...
    changeItems() {
      ...
      for (s = 0, i = t.length; s < i; s++)
        ((h = t[s]).x = r),
          (r += h.width * h.scaleX + this._space),
          this._align == A.TOP
            ? (h.y = 0)
  ...
  class N extends H {
    ...
    changeItems() {
      ...
      for (s = 0, i = t.length; s < i; s++)
        ((h = t[s]).y = r),
          (r += h.height * h.scaleY + this._space),
          this._align == N.LEFT
            ? (h.x = 0)
  ...
  class P extends g {
    ...
    set sheet(t) {
      ...
      for (var s = 0; s < this._clipY; s++)
        for (var i = e[s].split(""), h = 0, r = i.length; h < r; h++)
  ...
  class W extends n {
    constructor() {
      super(),
        ...
        e.ILaya.stage.on(a.SHOW_TIP, this, this._onStageShowTip),
        e.ILaya.stage.on(a.HIDE_TIP, this, this._onStageHideTip),
        (this.zOrder = 1100);
    }
    _onStageHideTip(t) {
